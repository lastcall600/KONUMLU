...
High-priority ADRs 001, 002, 003, 004, 007, 009, 011, 013 are accepted. ADR-005 and ADR-012 are accepted (G-04, G-07 resolved). ADR-014 is superseded / not needed (duplicates ADR-009). Remaining V1 blocking gates for 0A-32: none. G-06 (Corporate Workspace) is V1.5 and does not block V1 Phase 0A.
