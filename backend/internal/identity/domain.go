...
var (
	...
	errStepUpRequired         = errors.New("recent strong authentication required")
	errLastCredential         = errors.New("cannot remove last authentication factor")
	errInvalidStepUpPolicy    = errors.New("invalid step-up policy")
