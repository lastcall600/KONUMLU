...
| `notifications-policy.md` | NOTIFY-A purpose/channel taxonomy, consent vs preference, event catalog, AUTH-C mapping, 000052 schema, preference/consent/inbox HTTP, provider dispatch deferred. |
