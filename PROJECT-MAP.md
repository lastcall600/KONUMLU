...
| `NOTIFICATIONS.md` | Notification producer/dispatch operations: unconfigured providers, claim/retry, SES/Netgsm/push transports, destinations not logged |
...
| `/backend/migrations/` | Numbered SQL migrations (golang-migrate; SQL files only) | `000001`–`000053` (PostGIS, identity core through public profiles, platform outbox, notifications deliveries, listings core, location listing geo, media assets/processing, master data core + category EİDS requirement, search listing projection, favorites listing saves, saved search filter snapshots, messaging conversations/messages, verified appointments/challenges/interactions, trust projection + verified-review counters, reviews core, review aggregates, moderation reports + staff queue/cases/actions/appeals, businesses profiles/services + match location/category, needs core, offers core, transactions core, payments core, deliveries, disputes, eids verifications, notifications policy core, notifications push endpoints) |
