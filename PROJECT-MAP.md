...
| `/web/apps/consumer/` | Public consumer Next.js app (konumlu.com) | Initialized (Phase 0B-32 scaffold through listing/search/messaging/verified/trust/reviews as listed previously; Web Push browser client on `/bildirimler` with `public/sw.js`; see `web/apps/consumer/docs/web-push.md`) |
